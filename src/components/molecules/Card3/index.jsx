...
const Card3 = () => {
  return (
    <>
      <div className="m-5 h-56 sm:h-40 lg:h-52 items-center justify-center rounded border-2 border-gray-300 px-5 pb-5 hover:border-red-600 sm:block">
        <div className="flex items-center justify-around">
          <div className="flex items-center justify-center py-5">
            <img src={kim} className="mr-4 w-12 sm:w-10 xl:w-12" />
            <div className="items-center justify-center sm:mr-2 lg:mr-16 xl:mr-16">
              <p className="text-base font-bold xl:text-sm xl:font-medium">
                Kim Young Jou
              </p>
          ...
          <div className="flex items-center  justify-end py-5">
            <p className="text-sm font-medium md:ml-0 xl:ml-3">4.5</p>
            <div>
